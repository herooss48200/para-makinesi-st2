/** AGROS v4.5.3 — 27/27 runtime denetimi + yeni emir self-test + canlı atama kanıtı. */
...
const VERSION = 'v4.5.3-EXIT-FINALIZATION';
...
function telegram(model,limit=8){
  ...
  let t=`\n\n🏁 <b>EXIT ZAFER DENETİMİ — v4.5.3</b>\n`;
