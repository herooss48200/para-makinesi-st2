...
function learningEvolutionOzetMetni(s = {}) {
    try {
        ...
        const learningGapClosed = Number(current.closedRestartGap || 0);
        const learningGapActive = Number(continuity.trackedRestartGapActive || 0);
        const learningDifference = learningOpened - learningClosed - learningGapClosed - learningGapActive - learningActive;
        ...
        text += `🛡️ Sonradan GAP karantinası: Kapanan ${learningGapClosed} | Hâlen aktif ${learningGapActive} | Öğrenme dışı\n`;
