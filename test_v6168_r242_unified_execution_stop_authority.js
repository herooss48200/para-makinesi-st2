...
assert.ok(version.botSurumu.includes('R25.9-BOOTSTRAP-RECONCILE-DECOUPLED-N5-20SLOT-20USDT'));
...
console.log('✅ R25 unified execution stop authority passed | Real Premier + main Shadow/Development SL -2.5 | early profit lock + MACD shadow | LAB stop replay-only | 20 slot x 20USDT');
