...
assert.ok(memory.includes("{ timeoutMs: 5000, retryCount: 0, priority: 'critical' }"), 'startup Telegram fast policy mismatch');
...
assert.ok(/^6\.(3\.(5|6|7|8|9)|4\.(0|1|2|3)|5\.0|6\.[0-9]+|7\.[0-9]+)-/.test(version.botSurumu));
