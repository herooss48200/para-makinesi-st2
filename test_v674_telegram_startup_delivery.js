...
assert(hafiza.includes('retryCount: Math.max(0'), 'startup kritik hattında sınırlı retry eksik');
assert(hafiza.includes('const nativeProbeAllowed'), 'startup Native IPv4 ile başlamalı');
...
console.log('✅ v6.11.0 Telegram circuit delivery + truthful curl diagnostics passed');
