...
assert(src72.includes("'RENKO_15M_CLOSED_REVERSAL_PLUS_OFFSET'") && src72.includes("'RENKO_PATTERN_ADAPTIVE_BRICK_DISTANCE'"), 'DIRECT/CONFIRMED canlı tetik modları eksik');
...
assert.strictEqual(version.botSurumu, '6.13.5-R21-15M-CONFIRMED-TIMEFRAME-AUTHORITY-FINAL');
