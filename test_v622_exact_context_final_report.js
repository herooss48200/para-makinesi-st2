...
ok(report.includes('yalnız exact-context Premier sanal işlemlerini gösterir'),'portfolio exact-context footer missing');
...
ok(version.includes('6.2.2-EXACT-CONTEXT-FINAL-REPORT-RECONCILIATION'),'version missing');
console.log('✅ v6.2.2 exact-context final report + explicit reconciliation passed');
