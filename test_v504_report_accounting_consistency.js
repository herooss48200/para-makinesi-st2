...
try {
  ...
  assert.ok(reportSource.includes('Yeni bilimsel defter (Premier + Gölge)'));
  assert.ok(reportSource.includes('Öğrenme mutabakatı'));
  assert.ok(reportSource.includes('Sonradan GAP karantinası'));
