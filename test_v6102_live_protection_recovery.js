...
(async()=>{
  try {
    ...
    assert.strictEqual(ayarlar.calisilmakIstenenUsdtMiktar,10);
    ...
    assert.deepStrictEqual(bridge.liveRiskProfile(),{marginUsdt:10,notionalUsdt:20,leverage:2,marginType:'ISOLATED',maxActivePositions:10,protectionRequired:true});
