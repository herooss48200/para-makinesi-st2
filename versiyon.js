...
// v6.13.5-R25.7: startup KLINE dedicated agent hattına ayrıldı; timeout socket atandıktan sonra başlar. R25.3 Premier/N5 ve R25 stop ekonomisi korunur; MACD SHADOW-only.
...
const versiyon = Object.freeze({
    ...
    kodAdi: 'R25.7-STARTUP-DEDICATED-KLINE-20SLOT',
    kod: 'AGROS ST2 v6.13.5-R25.7 — STARTUP DEDICATED KLINE + R25.4 CORE LIVENESS + R25.3 PREMIER RECOVERY + 20 SLOT × 20USDT',
    botSurumu: '6.13.5-R25.7-STARTUP-DEDICATED-KLINE-N5-20SLOT-20USDT',
