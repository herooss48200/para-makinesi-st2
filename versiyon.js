...
// v6.10.1: v6.10.0 güvenliği + doğru Binance Futures endpoint otoritesi.

// v6.8.4 compatibility marker: 6.8.4-MINIMAL-TELEGRAM-OPERATION-PROOF
const versiyon = Object.freeze({
    isim: 'Para Makinesi Binance',
    kodAdi: 'ST2-RENKO-REAL-ORDER-ENDPOINT-AUTHORITY',
    kod: 'AGROS ST2 v6.10.1 — REAL ORDER ENDPOINT AUTHORITY',
    botSurumu: '6.10.1-REAL-ORDER-ENDPOINT-AUTHORITY',
