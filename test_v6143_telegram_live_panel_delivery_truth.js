...
assert(version.includes('6.13.5-R13-CORE-LOOP-LIVENESS-ST1-SHADOW-ISOLATION'), 'R11 sürüm etiketi eksik');
...
console.log('✅ v6.13.5-R13 Telegram delivery truth passed | bounded edit + latest-only worker + no transient send storm');
