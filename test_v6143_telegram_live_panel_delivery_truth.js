...
assert(version.includes('6.13.5-R14-CRITICAL-TICKER-DEADLINE-FIRST-AUDIT-ISOLATION'), 'R11 sürüm etiketi eksik');
...
console.log('✅ v6.13.5-R14 Telegram delivery truth passed | bounded edit + latest-only worker + no transient send storm');
