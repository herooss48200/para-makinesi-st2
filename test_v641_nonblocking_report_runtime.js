...
assert(bot.includes('canliRaporCalisiyor') && bot.includes('CANLI RAPOR ARKA PLAN HATASI'), 'Canlı rapor arka plan koruması korunmalı');
...
assert(settings.includes('st2DetayRaporMinAralikMs: 300000'), 'Detay rapor aralığı 5 dakika olmalı');
assert(version.includes('6.4.1-NONBLOCKING-REPORT-RUNTIME'), 'Runtime sürümü v6.4.1 olmalı');
