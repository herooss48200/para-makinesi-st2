...
assert(settings.includes('st2DetayRaporMinAralikMs: 300000') || settings.includes('st2DetayRaporMinAralikMs: 600000') || settings.includes('st2DetayRaporMinAralikMs: 900000'), 'Detay rapor aralığı en az 5 dakika olmalı');
assert(version.includes('6.4.1-NONBLOCKING-REPORT-RUNTIME') || version.includes('6.4.2-REPORT-QUEUE-MEMORY-PRESSURE') || version.includes('6.4.3-PREMIER-REPORT-TRUTH') || version.includes('6.5.0-MFE-CAPTURE-TAKEOVER-EVOLUTION') || version.includes('6.6.0-LEARNED-TAKEOVER-EXPLAINABLE-PROTECTION') || version.includes('6.6.1-PREMIER-TRUTH-PROTECTION-SHADOW-LOCK') || version.includes('6.6.2-30S-LIVE-TELEGRAM-PANEL-REPORT-TRUTH') || version.includes('6.7.0-ONLINE-ADAPTIVE-ATR-EXIT-PRIORITY-TELEGRAM'), 'Runtime sürümü v6.4.1+ olmalı');
