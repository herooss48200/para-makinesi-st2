...
assert(version.includes('6.4.1-NONBLOCKING-REPORT-RUNTIME') || version.includes('6.4.2-REPORT-QUEUE-MEMORY-PRESSURE') || version.includes('6.4.3-PREMIER-REPORT-TRUTH'), 'Runtime sürümü v6.4.1+ olmalı');
